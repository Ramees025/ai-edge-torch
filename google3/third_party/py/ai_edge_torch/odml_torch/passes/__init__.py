...
# ==============================================================================
from ai_edge_torch.odml_torch.passes import _mlirOdmlTorchPasses as _cextOdmlTorchPasses
...
def lift_callsite_loc_caller(module: ir.Module):
  return run_pass("builtin.module(lift-callsite-loc-caller)", module)


def build_stablehlo_composite(module: ir.Module):
  return run_pass("builtin.module(build-stablehlo-composite,cse)", module)
