...
_TORCH_XLA2_IMPLS = torch_xla2.ops.all_aten_jax_ops()
...
lower_by_torch_xla2(torch.ops.aten.copy_)
lower_by_torch_xla2(torch.ops.aten.copy_.default)
...
lower_by_torch_xla2(torch.ops.aten.div_)
...
lower_by_torch_xla2(torch.ops.aten.index_put_)
...
lower_by_torch_xla2(torch.ops.aten.scalar_tensor.default)
